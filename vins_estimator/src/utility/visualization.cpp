...
void pubLatestOdometry(const Eigen::Vector3d &P, const Eigen::Quaterniond &Q, const Eigen::Vector3d &V, const Eigen::Vector3d &G, const std_msgs::Header &header)
{
    ...
    odometry.twist.twist.angular.x = G.x();
    odometry.twist.twist.angular.y = G.y();
    odometry.twist.twist.angular.z = G.z();
